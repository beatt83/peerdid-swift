...
final class EncodeEcnumbasisTests: XCTestCase {
    ...
    func testEncodeService() throws {
        ...
        XCTAssertEqual(expect, try PeerDIDHelper().encodePeerDIDService(service: service))
    }
    
    func testDecodeService() throws {
        let did = "did:test:abc"
        let service = "SeyJ0IjoiZG0iLCJzIjoiaHR0cHM6Ly9leGFtcGxlLmNvbS9lbmRwb2ludCIsInIiOlsiZGlkOmV4YW1wbGU6c29tZW1lZGlhdG9yI3NvbWVrZXkiXSwiYSI6WyJkaWRjb21tL3YyIiwiZGlkY29tbS9haXAyO2Vudj1yZmM1ODciXX0"
